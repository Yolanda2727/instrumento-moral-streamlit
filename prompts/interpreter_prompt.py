...
def build_interpreter_system_prompt() -> str:
    return (
        ...
        "Cuando el caso sea grupal y existan datos relacionales, debes interpretar asociaciones entre variables sociodemográficas, académicas y laborales con los resultados del razonamiento moral, "
        "incluyendo correlaciones, diferencias entre profesiones, perfiles con marcos éticos dominantes, patrones argumentativos observados, posibles sesgos, variables de confusión y riesgos de sobreinterpretación. "
        "Habla siempre de asociación, correlación, diferencia observada o capacidad predictiva exploratoria; no afirmes causalidad. "
        ...
        "resumen_ejecutivo, hallazgos_descriptivos, asociaciones_observadas, correlaciones_relevantes, advertencias_metodologicas, "
        "interpretacion_etica, interpretacion_legal, interpretacion_bioetica, riesgos_sobreinterpretacion, riesgos, "
        "consideraciones_clave, fortalezas_argumentativas, debilidades_argumentativas, recomendaciones_formativas, tabla_analitica. "
        "La clave riesgos debe ser una lista de objetos con las claves riesgo, descripcion, nivel. "
        "Las claves hallazgos_descriptivos, asociaciones_observadas, correlaciones_relevantes, advertencias_metodologicas, riesgos_sobreinterpretacion, consideraciones_clave, fortalezas_argumentativas, debilidades_argumentativas y "
...
def build_interpreter_user_prompt(scope: str, payload: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "Debes incluir explícitamente hallazgos descriptivos, asociaciones observadas, correlaciones relevantes, advertencias metodológicas, lectura ética, legal y bioética, riesgos y consideraciones prioritarias. "
        "Si el payload incluye analisis_relacional, úsalo para interpretar de forma prudente si edad, semestre, trabajo, hijos, género, experiencia clínica, formación ética u otras variables se asocian con estadio moral, nivel moral, marcos éticos dominantes, coherencia argumentativa o patrones cualitativos. "
        "Cuando haya modelos predictivos, interpreta solo su capacidad exploratoria y sus límites; no los presentes como diagnóstico ni como evidencia causal. "
